          ...
          {loading ? (
            ...
            threads.map(thread => (
              <div
                ...
                onKeyDown={(e) => { if (e.key === 'Enter') { onSelectThread(thread.id); onClose(); } }}
                className={`w-full text-left px-4 py-3 border-b border-[var(--haven-border)] hover:bg-[var(--haven-card)] transition-colors group relative cursor-pointer ${
